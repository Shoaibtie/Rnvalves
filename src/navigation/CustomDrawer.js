    ...
    <View {...props} style={{flex: 1}}>
      <ImageBackground
        ...
        <View
          ...
          <View
            ...
            <Text style={{color: '#fff', marginLeft: 5}}>Hi Shoaib</Text>
      ...
      <DrawerContentScrollView>
        ...
        <TouchableOpacity
          ...
          <View style={{width: '80%', height: 60, justifyContent: 'center'}}>
            <Text style={{fontWeight: '500', fontSize: 14, color:'#3E3E3E'}}>Product</Text>
          </View>
        </TouchableOpacity>
      ...
      {/* ##################   4  ######################## */}
        ...
        <TouchableOpacity
          ...
          <View style={{width: '80%', height: 60, justifyContent: 'center'}}>
            <Text style={{fontWeight: '500', fontSize: 14,color:'#3E3E3E'}}>Dealer</Text>
          </View>
        </TouchableOpacity>
